...
namespace Core
{
    public class SkinPart : MonoBehaviour
    {
        ...
        [Space]
        [Header("PartType")]
        [SerializeField] private CharacterMonsterType typePart;
        ...
        [SerializeField] private GameObject lockRWPopup;
        [SerializeField] private GameObject loadIcon;
        [SerializeField] private GameObject rwIcon;
        [SerializeField] private Text counterRW;
        ...
        [Space]
        [Header("MoneyPart")]
        [SerializeField] private GameObject buttonPrice;
        ...
        {
            _camera = Camera.main;
            _tableChoose = FindObjectOfType<TableChooseParts>();
        ...
        public void BuyPart()
        {
            if(MoneyWallet.Instance.GetMoney() >= price)
            {
