...
namespace Cor
{
    public class Shop : MonoBehaviour
    {
        ...
        [Header("ShopButtons")]
        [SerializeField] List<ShopButton> allShopButtons = new List<ShopButton>();
        [SerializeField] List<ShopButton> pricesShopButtons = new List<ShopButton>();
        ...
        private void FixedUpdate()
        {
           ...
           {
                if(MoneyWallet.Instance.Money() >= pricesShopButtons[i].GetPrice())
                {
        ...
        public void CheckButtons(ButtonType buttonType)
        {
            int index = 0;
